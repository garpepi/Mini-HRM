		...
		<?php endif;?>
			<div class="panel panel-default">
				...
				<div class="panel-body">
					<div class="row">
						<div class="col-lg-6">
							<form role="form" method='post' action='<?php echo base_url().'division/'.($this->uri->segment(2) == 'edit' ? 'edit/'.$contents['data']['id'] : 'add');?>'>
										...
										<table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-active">
											...
											<tbody>
												...
												<tr>
													...
													<td>
														<a class="btn btn-secondary btn-xs" href='<?php echo base_url().'division/edit/'.$value['id'];?>'><i class="fa fa-edit"></i> Edit</a>
														<a class="btn btn-secondary btn-x confirmation" href='<?php echo base_url().'division/revoke/'.$value['id'];?>'><i class="fa fa-exchange"></i> Change Status</a>
													</td>
												</tr>
												<?php endforeach;?>
											</tbody>
										...
										<table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-inactive">
											...
											<tbody>
												...
												<tr>
													<td><?php echo $value['name']; ?></td>
													<td>
														<a class="btn btn-secondary btn-xs confirmation" href='<?php echo base_url().'division/reactivate/'.$value['id'];?>'><i class="fa fa-exchange"></i> Change Status</a>
													</td>
												</tr>
												<?php endforeach;?>
											</tbody>
