						...
						<tbody>
							<?php foreach($contents['active_table'] as $key => $value):?>
								<tr>
									...
									<td>
										<a href="<?php echo base_url().'sick/edit/'.$value['id'];?>" class="btn btn-secondary btn-xs"><i class="fa fa-edit"></i> Edit</a>
										<a href="<?php echo base_url().'sick/revoke/'.$value['id'];?>" class="btn btn-secondary btn-xs"><i class="fa fa-edit"></i> Revoke</a>
									</td>
								</tr>
							<?php endforeach;?>
						</tbody>
						...
						<tbody>
							<?php foreach($contents['inactive_table'] as $key => $value):?>
								<tr>
									...
									<td><?php echo $value['reason'];?></td>
									<td>
										<a href="<?php echo base_url().'sick/reactivate/'.$value['id'];?>" class="btn btn-secondary btn-xs"><i class="fa fa-edit"></i> Reactivate</a>
									</td>
								</tr>
							<?php endforeach;?>
						</tbody>
